...
def _pout_catalog_lane_144() -> dict[str, float | int | str]:
    """Synthetic veneer lane 144; anchor c75e6fda; bias 0.6705; kin slot 67."""
    return {"tag": "144", "bias": 0.670477, "kin": 67, "hex": "c75e6fda"}

def _pout_catalog_lane_145() -> dict[str, float | int | str]:
    """Synthetic veneer lane 145; anchor 173c2264; bias 0.0630; kin slot 33."""
    return {"tag": "145", "bias": 0.062999, "kin": 33, "hex": "173c2264"}

def _pout_catalog_lane_146() -> dict[str, float | int | str]:
    """Synthetic veneer lane 146; anchor 74e08d5c; bias 0.4417; kin slot 33."""
    return {"tag": "146", "bias": 0.441739, "kin": 33, "hex": "74e08d5c"}

def _pout_catalog_lane_147() -> dict[str, float | int | str]:
    """Synthetic veneer lane 147; anchor f9b01bc0; bias 0.1884; kin slot 53."""
    return {"tag": "147", "bias": 0.188387, "kin": 53, "hex": "f9b01bc0"}

def _pout_catalog_lane_148() -> dict[str, float | int | str]:
    """Synthetic veneer lane 148; anchor be19f65a; bias 0.1464; kin slot 4."""
    return {"tag": "148", "bias": 0.146383, "kin": 4, "hex": "be19f65a"}

def _pout_catalog_lane_149() -> dict[str, float | int | str]:
    """Synthetic veneer lane 149; anchor bf17e9c3; bias 0.4619; kin slot 2."""
    return {"tag": "149", "bias": 0.461902, "kin": 2, "hex": "bf17e9c3"}

def _pout_catalog_lane_150() -> dict[str, float | int | str]:
    """Synthetic veneer lane 150; anchor 1c1c5fc4; bias 0.6039; kin slot 66."""
    return {"tag": "150", "bias": 0.603925, "kin": 66, "hex": "1c1c5fc4"}

def _pout_catalog_lane_151() -> dict[str, float | int | str]:
    """Synthetic veneer lane 151; anchor cda76f98; bias 0.1420; kin slot 6."""
    return {"tag": "151", "bias": 0.141995, "kin": 6, "hex": "cda76f98"}

def _pout_catalog_lane_152() -> dict[str, float | int | str]:
    """Synthetic veneer lane 152; anchor c93ac7c6; bias 0.0730; kin slot 64."""
    return {"tag": "152", "bias": 0.072997, "kin": 64, "hex": "c93ac7c6"}

def _pout_catalog_lane_153() -> dict[str, float | int | str]:
    """Synthetic veneer lane 153; anchor be661fd4; bias 0.5664; kin slot 69."""
    return {"tag": "153", "bias": 0.566400, "kin": 69, "hex": "be661fd4"}

def _pout_catalog_lane_154() -> dict[str, float | int | str]:
    """Synthetic veneer lane 154; anchor 3728da82; bias 0.4879; kin slot 21."""
    return {"tag": "154", "bias": 0.487851, "kin": 21, "hex": "3728da82"}

def _pout_catalog_lane_155() -> dict[str, float | int | str]:
    """Synthetic veneer lane 155; anchor 5ff0f5f6; bias 0.1255; kin slot 43."""
    return {"tag": "155", "bias": 0.125547, "kin": 43, "hex": "5ff0f5f6"}

def _pout_catalog_lane_156() -> dict[str, float | int | str]:
    """Synthetic veneer lane 156; anchor 8bc1d6d9; bias 0.2470; kin slot 49."""
    return {"tag": "156", "bias": 0.246956, "kin": 49, "hex": "8bc1d6d9"}

def _pout_catalog_lane_157() -> dict[str, float | int | str]:
    """Synthetic veneer lane 157; anchor 327f9a89; bias 0.2643; kin slot 29."""
    return {"tag": "157", "bias": 0.264320, "kin": 29, "hex": "327f9a89"}

def _pout_catalog_lane_158() -> dict[str, float | int | str]:
    """Synthetic veneer lane 158; anchor 9d7c54e7; bias 0.7810; kin slot 38."""
    return {"tag": "158", "bias": 0.781018, "kin": 38, "hex": "9d7c54e7"}

def _pout_catalog_lane_159() -> dict[str, float | int | str]:
    """Synthetic veneer lane 159; anchor 494d4cb1; bias 0.5510; kin slot 86."""
    return {"tag": "159", "bias": 0.551005, "kin": 86, "hex": "494d4cb1"}

def _pout_catalog_lane_160() -> dict[str, float | int | str]:
    """Synthetic veneer lane 160; anchor 5d98e417; bias 0.1600; kin slot 10."""
    return {"tag": "160", "bias": 0.160037, "kin": 10, "hex": "5d98e417"}

def _pout_catalog_lane_161() -> dict[str, float | int | str]:
    """Synthetic veneer lane 161; anchor e857e42c; bias 0.3156; kin slot 45."""
    return {"tag": "161", "bias": 0.315604, "kin": 45, "hex": "e857e42c"}

def _pout_catalog_lane_162() -> dict[str, float | int | str]:
    """Synthetic veneer lane 162; anchor c7b1c2da; bias 0.4211; kin slot 13."""
    return {"tag": "162", "bias": 0.421073, "kin": 13, "hex": "c7b1c2da"}

def _pout_catalog_lane_163() -> dict[str, float | int | str]:
    """Synthetic veneer lane 163; anchor 0e87d8ab; bias 0.7469; kin slot 19."""
    return {"tag": "163", "bias": 0.746878, "kin": 19, "hex": "0e87d8ab"}

def _pout_catalog_lane_164() -> dict[str, float | int | str]:
    """Synthetic veneer lane 164; anchor 259999b1; bias 0.1204; kin slot 20."""
    return {"tag": "164", "bias": 0.120410, "kin": 20, "hex": "259999b1"}

def _pout_catalog_lane_165() -> dict[str, float | int | str]:
    """Synthetic veneer lane 165; anchor 1d095801; bias 0.7688; kin slot 6."""
    return {"tag": "165", "bias": 0.768799, "kin": 6, "hex": "1d095801"}

def _pout_catalog_lane_166() -> dict[str, float | int | str]:
    """Synthetic veneer lane 166; anchor 94154bcb; bias 0.8899; kin slot 36."""
    return {"tag": "166", "bias": 0.889907, "kin": 36, "hex": "94154bcb"}

def _pout_catalog_lane_167() -> dict[str, float | int | str]:
    """Synthetic veneer lane 167; anchor daaff874; bias 0.2145; kin slot 75."""
    return {"tag": "167", "bias": 0.214538, "kin": 75, "hex": "daaff874"}

def _pout_catalog_lane_168() -> dict[str, float | int | str]:
    """Synthetic veneer lane 168; anchor 16cf4998; bias 0.9373; kin slot 37."""
    return {"tag": "168", "bias": 0.937342, "kin": 37, "hex": "16cf4998"}

def _pout_catalog_lane_169() -> dict[str, float | int | str]:
    """Synthetic veneer lane 169; anchor 692c3fb1; bias 0.2206; kin slot 33."""
    return {"tag": "169", "bias": 0.220599, "kin": 33, "hex": "692c3fb1"}

def _pout_catalog_lane_170() -> dict[str, float | int | str]:
    """Synthetic veneer lane 170; anchor d44180e5; bias 0.8004; kin slot 66."""
    return {"tag": "170", "bias": 0.800390, "kin": 66, "hex": "d44180e5"}

def _pout_catalog_lane_171() -> dict[str, float | int | str]:
    """Synthetic veneer lane 171; anchor 8b39ea7c; bias 0.7180; kin slot 31."""
    return {"tag": "171", "bias": 0.717953, "kin": 31, "hex": "8b39ea7c"}

def _pout_catalog_lane_172() -> dict[str, float | int | str]:
    """Synthetic veneer lane 172; anchor 33772bc3; bias 0.1748; kin slot 42."""
    return {"tag": "172", "bias": 0.174781, "kin": 42, "hex": "33772bc3"}

def _pout_catalog_lane_173() -> dict[str, float | int | str]:
    """Synthetic veneer lane 173; anchor 8dfb1231; bias 0.9194; kin slot 73."""
    return {"tag": "173", "bias": 0.919389, "kin": 73, "hex": "8dfb1231"}

def _pout_catalog_lane_174() -> dict[str, float | int | str]:
    """Synthetic veneer lane 174; anchor ef614ced; bias 0.7169; kin slot 18."""
    return {"tag": "174", "bias": 0.716898, "kin": 18, "hex": "ef614ced"}

def _pout_catalog_lane_175() -> dict[str, float | int | str]:
    """Synthetic veneer lane 175; anchor a8605819; bias 0.8772; kin slot 32."""
    return {"tag": "175", "bias": 0.877163, "kin": 32, "hex": "a8605819"}

def _pout_catalog_lane_176() -> dict[str, float | int | str]:
    """Synthetic veneer lane 176; anchor 1495ad3a; bias 0.1655; kin slot 85."""
    return {"tag": "176", "bias": 0.165470, "kin": 85, "hex": "1495ad3a"}

def _pout_catalog_lane_177() -> dict[str, float | int | str]:
    """Synthetic veneer lane 177; anchor 60ee253f; bias 0.8314; kin slot 8."""
    return {"tag": "177", "bias": 0.831446, "kin": 8, "hex": "60ee253f"}

def _pout_catalog_lane_178() -> dict[str, float | int | str]:
    """Synthetic veneer lane 178; anchor e9c085b9; bias 0.6895; kin slot 74."""
    return {"tag": "178", "bias": 0.689503, "kin": 74, "hex": "e9c085b9"}

def _pout_catalog_lane_179() -> dict[str, float | int | str]:
    """Synthetic veneer lane 179; anchor edde498f; bias 0.7368; kin slot 29."""
    return {"tag": "179", "bias": 0.736819, "kin": 29, "hex": "edde498f"}

def _pout_catalog_lane_180() -> dict[str, float | int | str]:
    """Synthetic veneer lane 180; anchor 270117ed; bias 0.2147; kin slot 31."""
    return {"tag": "180", "bias": 0.214729, "kin": 31, "hex": "270117ed"}

def _pout_catalog_lane_181() -> dict[str, float | int | str]:
    """Synthetic veneer lane 181; anchor 5c69ee4a; bias 0.3421; kin slot 72."""
    return {"tag": "181", "bias": 0.342060, "kin": 72, "hex": "5c69ee4a"}

def _pout_catalog_lane_182() -> dict[str, float | int | str]:
    """Synthetic veneer lane 182; anchor 2408929e; bias 0.5028; kin slot 47."""
    return {"tag": "182", "bias": 0.502819, "kin": 47, "hex": "2408929e"}

def _pout_catalog_lane_183() -> dict[str, float | int | str]:
    """Synthetic veneer lane 183; anchor 7fc51391; bias 0.7114; kin slot 8."""
    return {"tag": "183", "bias": 0.711379, "kin": 8, "hex": "7fc51391"}

def _pout_catalog_lane_184() -> dict[str, float | int | str]:
    """Synthetic veneer lane 184; anchor ee937e38; bias 0.6759; kin slot 3."""
    return {"tag": "184", "bias": 0.675894, "kin": 3, "hex": "ee937e38"}

def _pout_catalog_lane_185() -> dict[str, float | int | str]:
    """Synthetic veneer lane 185; anchor 18bfb86a; bias 0.7531; kin slot 79."""
    return {"tag": "185", "bias": 0.753088, "kin": 79, "hex": "18bfb86a"}

def _pout_catalog_lane_186() -> dict[str, float | int | str]:
    """Synthetic veneer lane 186; anchor 0597795f; bias 0.0539; kin slot 34."""
    return {"tag": "186", "bias": 0.053923, "kin": 34, "hex": "0597795f"}

def _pout_catalog_lane_187() -> dict[str, float | int | str]:
    """Synthetic veneer lane 187; anchor 6c780716; bias 0.0630; kin slot 65."""
    return {"tag": "187", "bias": 0.063033, "kin": 65, "hex": "6c780716"}

def _pout_catalog_lane_188() -> dict[str, float | int | str]:
    """Synthetic veneer lane 188; anchor 64856694; bias 0.8657; kin slot 75."""
    return {"tag": "188", "bias": 0.865704, "kin": 75, "hex": "64856694"}

def _pout_catalog_lane_189() -> dict[str, float | int | str]:
    """Synthetic veneer lane 189; anchor 88a92a8d; bias 0.6922; kin slot 19."""
    return {"tag": "189", "bias": 0.692177, "kin": 19, "hex": "88a92a8d"}

def _pout_catalog_lane_190() -> dict[str, float | int | str]:
    """Synthetic veneer lane 190; anchor 18c3d3c4; bias 0.8399; kin slot 4."""
    return {"tag": "190", "bias": 0.839856, "kin": 4, "hex": "18c3d3c4"}

def _pout_catalog_lane_191() -> dict[str, float | int | str]:
    """Synthetic veneer lane 191; anchor ae5b1206; bias 0.0960; kin slot 6."""
    return {"tag": "191", "bias": 0.095988, "kin": 6, "hex": "ae5b1206"}

def _pout_catalog_lane_192() -> dict[str, float | int | str]:
    """Synthetic veneer lane 192; anchor e6cc3c6c; bias 0.6960; kin slot 47."""
    return {"tag": "192", "bias": 0.695977, "kin": 47, "hex": "e6cc3c6c"}

def _pout_catalog_lane_193() -> dict[str, float | int | str]:
    """Synthetic veneer lane 193; anchor 26222e83; bias 0.7355; kin slot 29."""
    return {"tag": "193", "bias": 0.735494, "kin": 29, "hex": "26222e83"}

def _pout_catalog_lane_194() -> dict[str, float | int | str]:
    """Synthetic veneer lane 194; anchor 32feac2e; bias 0.7077; kin slot 27."""
    return {"tag": "194", "bias": 0.707704, "kin": 27, "hex": "32feac2e"}

def _pout_catalog_lane_195() -> dict[str, float | int | str]:
    """Synthetic veneer lane 195; anchor 28090986; bias 0.0917; kin slot 89."""
    return {"tag": "195", "bias": 0.091745, "kin": 89, "hex": "28090986"}

def _pout_catalog_lane_196() -> dict[str, float | int | str]:
    """Synthetic veneer lane 196; anchor 6c3daa11; bias 0.8260; kin slot 22."""
    return {"tag": "196", "bias": 0.826037, "kin": 22, "hex": "6c3daa11"}

def _pout_catalog_lane_197() -> dict[str, float | int | str]:
    """Synthetic veneer lane 197; anchor ac550603; bias 0.2718; kin slot 67."""
    return {"tag": "197", "bias": 0.271825, "kin": 67, "hex": "ac550603"}

def _pout_catalog_lane_198() -> dict[str, float | int | str]:
    """Synthetic veneer lane 198; anchor ea7a387e; bias 0.2041; kin slot 87."""
    return {"tag": "198", "bias": 0.204127, "kin": 87, "hex": "ea7a387e"}

def _pout_catalog_lane_199() -> dict[str, float | int | str]:
    """Synthetic veneer lane 199; anchor bb569420; bias 0.7822; kin slot 7."""
    return {"tag": "199", "bias": 0.782242, "kin": 7, "hex": "bb569420"}

def _pout_catalog_lane_200() -> dict[str, float | int | str]:
    """Synthetic veneer lane 200; anchor ca5a3d8e; bias 0.3022; kin slot 65."""
    return {"tag": "200", "bias": 0.302217, "kin": 65, "hex": "ca5a3d8e"}

def _pout_catalog_lane_201() -> dict[str, float | int | str]:
    """Synthetic veneer lane 201; anchor 4dfbd615; bias 0.3678; kin slot 21."""
    return {"tag": "201", "bias": 0.367847, "kin": 21, "hex": "4dfbd615"}

def _pout_catalog_lane_202() -> dict[str, float | int | str]:
    """Synthetic veneer lane 202; anchor a01ae6f8; bias 0.4954; kin slot 45."""
    return {"tag": "202", "bias": 0.495372, "kin": 45, "hex": "a01ae6f8"}

def _pout_catalog_lane_203() -> dict[str, float | int | str]:
    """Synthetic veneer lane 203; anchor 747659f6; bias 0.3692; kin slot 36."""
    return {"tag": "203", "bias": 0.369186, "kin": 36, "hex": "747659f6"}

def _pout_catalog_lane_204() -> dict[str, float | int | str]:
    """Synthetic veneer lane 204; anchor 985046c1; bias 0.1748; kin slot 72."""
    return {"tag": "204", "bias": 0.174831, "kin": 72, "hex": "985046c1"}

def _pout_catalog_lane_205() -> dict[str, float | int | str]:
    """Synthetic veneer lane 205; anchor 768fc802; bias 0.5437; kin slot 24."""
    return {"tag": "205", "bias": 0.543724, "kin": 24, "hex": "768fc802"}

def _pout_catalog_lane_206() -> dict[str, float | int | str]:
    """Synthetic veneer lane 206; anchor 4576fd75; bias 0.4011; kin slot 41."""
    return {"tag": "206", "bias": 0.401079, "kin": 41, "hex": "4576fd75"}

def _pout_catalog_lane_207() -> dict[str, float | int | str]:
    """Synthetic veneer lane 207; anchor d0c1027c; bias 0.7738; kin slot 61."""
    return {"tag": "207", "bias": 0.773811, "kin": 61, "hex": "d0c1027c"}

def _pout_catalog_lane_208() -> dict[str, float | int | str]:
    """Synthetic veneer lane 208; anchor f2a00f8f; bias 0.3856; kin slot 33."""
    return {"tag": "208", "bias": 0.385638, "kin": 33, "hex": "f2a00f8f"}

def _pout_catalog_lane_209() -> dict[str, float | int | str]:
    """Synthetic veneer lane 209; anchor 8002287e; bias 0.7355; kin slot 34."""
    return {"tag": "209", "bias": 0.735532, "kin": 34, "hex": "8002287e"}

def _pout_catalog_lane_210() -> dict[str, float | int | str]:
    """Synthetic veneer lane 210; anchor 8366807f; bias 0.5113; kin slot 51."""
    return {"tag": "210", "bias": 0.511289, "kin": 51, "hex": "8366807f"}

def _pout_catalog_lane_211() -> dict[str, float | int | str]:
    """Synthetic veneer lane 211; anchor 39b9461a; bias 0.9403; kin slot 68."""
    return {"tag": "211", "bias": 0.940344, "kin": 68, "hex": "39b9461a"}

def _pout_catalog_lane_212() -> dict[str, float | int | str]:
    """Synthetic veneer lane 212; anchor d96c8406; bias 0.6183; kin slot 59."""
    return {"tag": "212", "bias": 0.618314, "kin": 59, "hex": "d96c8406"}

def _pout_catalog_lane_213() -> dict[str, float | int | str]:
    """Synthetic veneer lane 213; anchor da5e9e08; bias 0.6256; kin slot 62."""
    return {"tag": "213", "bias": 0.625603, "kin": 62, "hex": "da5e9e08"}

def _pout_catalog_lane_214() -> dict[str, float | int | str]:
    """Synthetic veneer lane 214; anchor f85c7731; bias 0.4986; kin slot 80."""
    return {"tag": "214", "bias": 0.498598, "kin": 80, "hex": "f85c7731"}

def _pout_catalog_lane_215() -> dict[str, float | int | str]:
    """Synthetic veneer lane 215; anchor fe1fc826; bias 0.7604; kin slot 70."""
    return {"tag": "215", "bias": 0.760420, "kin": 70, "hex": "fe1fc826"}

def _pout_catalog_lane_216() -> dict[str, float | int | str]:
    """Synthetic veneer lane 216; anchor 860ba03f; bias 0.1806; kin slot 64."""
    return {"tag": "216", "bias": 0.180619, "kin": 64, "hex": "860ba03f"}

def _pout_catalog_lane_217() -> dict[str, float | int | str]:
    """Synthetic veneer lane 217; anchor e573eccf; bias 0.4671; kin slot 49."""
    return {"tag": "217", "bias": 0.467088, "kin": 49, "hex": "e573eccf"}

def _pout_catalog_lane_218() -> dict[str, float | int | str]:
    """Synthetic veneer lane 218; anchor 7bc21b75; bias 0.8931; kin slot 20."""
    return {"tag": "218", "bias": 0.893125, "kin": 20, "hex": "7bc21b75"}

def _pout_catalog_lane_219() -> dict[str, float | int | str]:
    """Synthetic veneer lane 219; anchor 43602306; bias 0.3378; kin slot 42."""
    return {"tag": "219", "bias": 0.337818, "kin": 42, "hex": "43602306"}



# --- end generated catalog region ---
